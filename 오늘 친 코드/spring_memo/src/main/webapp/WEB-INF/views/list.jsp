...
//검색관련--------------
//Action에서 저장한 model결과 및 JSP에서 사용할 내용을 꺼낸다.
...
#BE{
background:    #ff00ff;
background:    linear-gradient(#000000, #ff00ff 50%, #000000);
border-radius: 9px;
...
<div class='form-group'>
 <select class='form-control' name='col'>
  ...
  <option value="content" <%if(col.equals("content")) out.print("selected");%> >메모 내용</option>
...
<button class='btn btn-default' id="BE">검색</button>
